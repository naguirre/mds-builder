...
- **`LEB size mismatch`** when mounting a UBIFS image generated by Buildroot — see [SPI NAND Partitioning](@/hardware/partitioning.md) for the exact LEB size that has to match.
